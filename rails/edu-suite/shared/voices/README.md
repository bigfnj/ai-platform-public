...
Place the reference clips here before running the pipeline for the first time.
...
- The voice used here will be the voice heard in every audio file generated all year.
  Once chosen, do not swap the reference clips mid-year — consistency matters for this learner.
...
- Avoid accents from Spain or other Latin American regions — the student is from Mexico
  and will recognize the difference

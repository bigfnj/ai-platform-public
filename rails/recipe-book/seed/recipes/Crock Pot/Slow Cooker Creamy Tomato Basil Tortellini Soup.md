...
- 1 3/4 cups diced yellow onion (1 large)
...
3. Remove bay leaves then puree mixture well in small batches in a blender (only fill blender 2/3 full and cover removable insert with a kitchen towel) or use an emulsion blender*.
...
---
*Source: Crock Pot/Slow Cooker Creamy Tomato Basil Tortellini Soup - Cooking Classy.pdf (extracted via pdftotext)*
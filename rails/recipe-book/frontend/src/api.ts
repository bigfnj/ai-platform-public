...
// Header model chips: the live four-state status of this rail's Ollama roles, polled by module.tsx.
export type Caps = { broker: "ok" | "unreachable"; models: ModelChip[] };
...
export const api = {
  ...
  // header model chips — live four-state status of the assistant + vision roles
  capabilities: () => req<Caps>("/api/capabilities"),
};

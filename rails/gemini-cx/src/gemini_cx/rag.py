...
corpus is GECX subject-matter content measured in thousands of chunks, not millions, so an
in-memory matrix multiply is both faster and far easier to reason about when a reader
...
def chunk_markdown(text: str, *, source: str, collection: str = "") -> list[dict]:
    ...
    The heading matters: this corpus is heavily sectioned ("Objection: not really agentic", "40+ vs 10 languages"),

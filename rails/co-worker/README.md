...
[inbox drop-zone]                    ← C:\Users\you\ai-platform\data\co-worker\inbox\
        ...
        ▼
[co-worker backend :8890]            ← /api/inbox serves raw items
...
npm run dev      # standalone on :5310, proxies /co-worker/api to :8890
```
...
`8890` — the next free slot in the platform sequence. 8860 is ai-voice, 8870 is
smb-partner-enablement and 8880 is gemini-cx; dev server is 5310 (5260 is ai-voice's).

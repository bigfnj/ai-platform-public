<#
  ...
  Registered by register-watchdog.ps1 as a DELIBERATE, elevated post-install step
  on Podman/WSL boxes (see WATCHDOG.md) - install.ps1 sets up only the lighter
  logon Startup shortcut, not this boot-time NSSM service.

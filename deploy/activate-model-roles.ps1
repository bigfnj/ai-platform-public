...
#   @edu/@job-aid/@finance-chat=mistral-small3*:24b  @iep/@bouquet-writer/@finance-fraud=qwen3.6*:27b
...
$roleVars = [ordered]@{
  ...
  'JOB_AID_LLM_MODEL'           = '@job-aid'        # was mistral-small3*:24b
  'FINANCE_LLM_MODEL'           = '@finance-chat'   # was mistral-small3*:24b
  'FINANCE_FRAUD_MODEL'         = '@finance-fraud'  # was qwen3:30b-a3b
  # RECIPE_BOOK_LLM_MODEL was here; the variable no longer exists anywhere (it was an
  # unreachable fallback — every call site passes an explicit @role).
...
$rails = @('dashboard','iep','job-aid','finance','recipe-book','bouquet','terminal-fun','ai-playground')
